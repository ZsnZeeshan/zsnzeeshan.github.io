...
<!--TODO: Also include BE FYP, MSc project, Robots and interest based projects -->
<!--TODO specify hardware, why and what-->
<!--TODO specify challenges and state of the art-->

### **Technical Mentorship (2020 – 2024)**  
A volunteer research initiative focused on mentoring engineers in software and ML for improving CAD simulation workflows, error-detection processes, and IT support systems.
<!--TODO Add link to research paper-->

### **IoT Audio Platform (2019)**  
Prototyped a scalable classroom IoT audio system, integrating real-time control, signal processing, and spatial sound analysis within a Python–Qt framework using a ReSpeaker Mic Array.
